...
void __Image()
{
    ...
    class_< Magick::Image >("Image", init<  >())
...
#if defined(PGMAGICK_LIB_IMAGEMAGICK) || defined(PGMAGICK_LIB_GRAPHICSMAGICK_1_3_22)
        ...
        .def("filterType", (Magick::FilterTypes (Magick::Image::*)(void) const)&Magick::Image::filterType)
